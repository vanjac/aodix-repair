...
- Check the box next to "Recommended patches" to enable all patches at once, or you can choose individual patches/categories. This should be done before loading any VSTs.
